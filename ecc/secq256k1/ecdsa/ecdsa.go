...
import (
	...
	"github.com/consensys/gnark-crypto/ecc/secq256k1"
...
func RecoverP(v uint, r *big.Int) (*secq256k1.G1Affine, error) {
	...
	x.Add(x, kn)
	// y^2 = x^3+ax+b
	a, b := secq256k1.CurveCoefficients()
